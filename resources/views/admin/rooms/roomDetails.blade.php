    ...
    <div class="py-32">
        <div class="relative h-20">
            <div class="absolute bottom-[8.2vh] left-[29.5vh]">
                <p class="text-4xl font-semibold text-gray-700">Room Details</p>
            </div>
        </div>


        <div class="bg-white shadow-md  ml-[30vh] w-[80%] ">
            <div id="default-carousel" class="relative mx-auto w-[60vh]" data-carousel="slide">
                <!-- Carousel wrapper -->

                <div class="relative h-[65vh] overflow-hidden rounded-lg ">
                    <!-- Item 1 -->
                    @foreach($details->roomImages as $image)
            ...
            <div class="mx-[20vh] grid grid-cols-3 gap-10 mt-10 pb-20">
                <div class=" p-4 rounded-lg w-[30vh]">
                    ...
                    <p class="whitespace-pre-line mt-4">{{$details->entertainment}}</p>
                </div>
            </div>
        </div>
    </div>
